    ...
    def _load_reviews(self, dataset, word_tfidf_threshold=0.1, word_freq_threshold=5000):
        ...
        for rid, data in enumerate(dataset.review.data):
            ...
            if len(review)<2:
                ...
                #print(review[0])
                remained_words = [review[0]]
            else:
                remained_words = [review[0],review[1]]
             '''
        ...
        print('uid pid reamained_words.',uid,';',pid,';',remained_words)
        print('type of remained words:',type(remained_words))
